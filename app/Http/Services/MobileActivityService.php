...
class MobileActivityService
{
    ...
    public function getActiveUsers(): array
    {
        ...
        // Process IPs (Redis returns flat array: [ip1, score1, ip2, score2, ...])
        for ($i = 0; $i < count($ips); $i += 2) {
            $ip = $ips[$i];
            $lastActivity = (int)$ips[$i + 1];
    ...
    public function getStats(): array
    {
        ...
        return [
            ...
            'active_last_5_min' => $activeInLast5Min,
            'active_last_1_min' => $activeInLast1Min,
