    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'turbosms' => \Daaner\TurboSMS\TurboSMS::class,
    ...
    override(\config(), map([
            ...
            'app.claim_base_url' => 'string',
            'app.deep_links.scheme' => 'string',
            'app.deep_links.host' => 'string',
            'app.deep_links.android_package' => 'string',
            'app.deep_links.android_store_url' => 'string',
            'app.deep_links.ios_bundle' => 'string',
            'app.deep_links.ios_store_url' => 'string',
            'app.master_invite_template' => 'string',
            'app.TurboSMS' => 'string',
            'app_versions.android.min_supported_build' => 'string',
            'app_versions.android.recommended_build' => 'string',
            'app_versions.android.message' => 'string',
            'app_versions.android.store_url' => 'string',
            'app_versions.ios.min_supported_build' => 'string',
            'app_versions.ios.recommended_build' => 'string',
            'app_versions.ios.message' => 'string',
            'app_versions.ios.store_url' => 'string',
            ...
            'auth.access_token_ttl' => 'integer',
            'auth.refresh_token_ttl_days' => 'integer',
            ...
            'database.redis.default.timeout' => 'integer',
            ...
            'database.redis.horizon.timeout' => 'integer',
            ...
            'images.thumb.size' => 'integer',
            'images.thumb.dir' => 'string',
            'jwt.secret' => 'string',
            ...
            'limits.max_photos_free' => 'integer',
            'limits.max_photos_premium' => 'integer',
            'limits.max_description_free' => 'integer',
            'limits.max_description_premium' => 'integer',
            'limits.max_services_free' => 'integer',
            'limits.max_services_premium' => 'integer',
            ...
            'masters.auto_mechanics.type' => 'string',
            'masters.auto_mechanics.type_key' => 'string',
            'masters.auto_mechanics.title' => 'string',
            'masters.auto_mechanics.description' => 'string',
            'masters.auto_mechanics.keywords' => 'string',
            'masters.auto_mechanics.city' => 'string',
            'masters.auto_mechanics.region' => 'string',
            'masters.auto_mechanics.country' => 'string',
            'masters.auto_mechanics.currency' => 'string',
            'masters.auto_mechanics.phone_country_code' => 'string',
            'masters.auto_mechanics.specializations' => 'array',
            'masters.auto_mechanics.services' => 'array',
            'masters.auto_mechanics.seo.enable_structured_data' => 'boolean',
            'masters.auto_mechanics.seo.enable_sitemap' => 'boolean',
            'masters.auto_mechanics.seo.enable_robots' => 'boolean',
            'masters.auto_mechanics.seo.enable_analytics' => 'boolean',
            'masters.beauty_salons.type' => 'string',
            'masters.beauty_salons.type_key' => 'string',
            'masters.beauty_salons.title' => 'string',
            'masters.beauty_salons.description' => 'string',
            'masters.beauty_salons.keywords' => 'string',
            'masters.beauty_salons.city' => 'string',
            'masters.beauty_salons.region' => 'string',
            'masters.beauty_salons.country' => 'string',
            'masters.beauty_salons.currency' => 'string',
            'masters.beauty_salons.phone_country_code' => 'string',
            'masters.beauty_salons.specializations' => 'array',
            'masters.beauty_salons.services' => 'array',
            'masters.beauty_salons.seo.enable_structured_data' => 'boolean',
            'masters.beauty_salons.seo.enable_sitemap' => 'boolean',
            'masters.beauty_salons.seo.enable_robots' => 'boolean',
            'masters.beauty_salons.seo.enable_analytics' => 'boolean',
            'masters.home_services.type' => 'string',
            'masters.home_services.type_key' => 'string',
            'masters.home_services.title' => 'string',
            'masters.home_services.description' => 'string',
            'masters.home_services.keywords' => 'string',
            'masters.home_services.city' => 'string',
            'masters.home_services.region' => 'string',
            'masters.home_services.country' => 'string',
            'masters.home_services.currency' => 'string',
            'masters.home_services.phone_country_code' => 'string',
            'masters.home_services.specializations' => 'array',
            'masters.home_services.services' => 'array',
            'masters.home_services.seo.enable_structured_data' => 'boolean',
            'masters.home_services.seo.enable_sitemap' => 'boolean',
            'masters.home_services.seo.enable_robots' => 'boolean',
            'masters.home_services.seo.enable_analytics' => 'boolean',
            'masters.default' => 'string',
            'masters.env.type' => 'string',
            'masters.env.city' => 'string',
            'masters.env.region' => 'string',
            'masters.env.country' => 'string',
            'masters.seo.default_locale' => 'string',
            'masters.seo.supported_locales' => 'array',
            'masters.seo.enable_structured_data' => 'boolean',
            'masters.seo.enable_sitemap' => 'boolean',
            'masters.seo.enable_robots' => 'boolean',
            'masters.seo.enable_analytics' => 'boolean',
            'masters.seo.google_analytics_id' => 'NULL',
            'masters.pagination.default_per_page' => 'integer',
            'masters.pagination.available_per_page' => 'array',
            'masters.pagination.max_per_page' => 'integer',
            'masters.filters.rating.min' => 'double',
            'masters.filters.rating.max' => 'double',
            'masters.filters.rating.step' => 'double',
            'masters.filters.age.min' => 'integer',
            'masters.filters.age.max' => 'integer',
            'masters.filters.experience.min' => 'integer',
            'masters.filters.experience.max' => 'integer',
            'masters.filters.price.min' => 'integer',
            'masters.filters.price.max' => 'integer',
            'masters.filters.price.currency' => 'string',
            'masters.filters.distance.min' => 'integer',
            'masters.filters.distance.max' => 'integer',
            'masters.filters.distance.unit' => 'string',
            'otp.universal_code' => 'string',
            'otp.enable_local_bypass' => 'boolean',
            'otp.local_bypass_code' => 'string',
            'otp.android_app_hash' => 'string',
            'pulse.domain' => 'NULL',
            'pulse.path' => 'string',
            ...
            'subscription.trial_enabled' => 'string',
            ...
            'turbosms.test_mode' => 'boolean',
            'turbosms.api_key' => 'string',
            'turbosms.sms_sender' => 'string',
            'turbosms.viber_sender' => 'string',
            'turbosms.sleep_mode' => 'boolean',
            'turbosms.min_hour' => 'integer',
            'turbosms.max_hour' => 'integer',
            'turbosms.http_response_timeout' => 'integer',
            'turbosms.http_retry_max_time' => 'integer',
            'turbosms.http_retry_delay' => 'integer',
...
'viewPulse','update','viewTelescope',);
...
'broadcasting.connections.null.driver','concurrency.default','app.name','app.env','app.debug',
...
'app.aliases.Validator','app.aliases.View','app.aliases.Vite','app.claim_base_url','app.deep_links.scheme',
'app.deep_links.host','app.deep_links.android_package','app.deep_links.android_store_url','app.deep_links.ios_bundle','app.deep_links.ios_store_url',
'app.master_invite_template','app.TurboSMS','app_versions.android.min_supported_build','app_versions.android.recommended_build','app_versions.android.message',
'app_versions.android.store_url','app_versions.ios.min_supported_build','app_versions.ios.recommended_build','app_versions.ios.message','app_versions.ios.store_url',
...
'auth.access_token_ttl','auth.refresh_token_ttl_days','cache.default','cache.stores.array.driver','cache.stores.array.serialize',
...
'database.redis.default.database','database.redis.default.timeout','database.redis.default.read_timeout','database.redis.cache.url','database.redis.cache.host',
...
'database.redis.horizon.timeout','database.redis.horizon.read_timeout','database.redis.horizon.options.prefix','filesystems.default','filesystems.disks.local.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./var/www/public/storage','horizon.domain','horizon.path',
...
'images.thumb.size','images.thumb.dir','jwt.secret','jwt.keys.public','jwt.keys.private',
...
'jwt.decrypt_cookies','jwt.providers.jwt','jwt.providers.auth','jwt.providers.storage','limits.max_photos_free',
'limits.max_photos_premium','limits.max_description_free','limits.max_description_premium','limits.max_services_free','limits.max_services_premium',
...
'mail.markdown.theme','mail.markdown.paths','masters.auto_mechanics.type','masters.auto_mechanics.type_key','masters.auto_mechanics.title',
'masters.auto_mechanics.description','masters.auto_mechanics.keywords','masters.auto_mechanics.city','masters.auto_mechanics.region','masters.auto_mechanics.country',
'masters.auto_mechanics.currency','masters.auto_mechanics.phone_country_code','masters.auto_mechanics.specializations','masters.auto_mechanics.services','masters.auto_mechanics.seo.enable_structured_data',
'masters.auto_mechanics.seo.enable_sitemap','masters.auto_mechanics.seo.enable_robots','masters.auto_mechanics.seo.enable_analytics','masters.beauty_salons.type','masters.beauty_salons.type_key',
'masters.beauty_salons.title','masters.beauty_salons.description','masters.beauty_salons.keywords','masters.beauty_salons.city','masters.beauty_salons.region',
'masters.beauty_salons.country','masters.beauty_salons.currency','masters.beauty_salons.phone_country_code','masters.beauty_salons.specializations','masters.beauty_salons.services',
'masters.beauty_salons.seo.enable_structured_data','masters.beauty_salons.seo.enable_sitemap','masters.beauty_salons.seo.enable_robots','masters.beauty_salons.seo.enable_analytics','masters.home_services.type',
'masters.home_services.type_key','masters.home_services.title','masters.home_services.description','masters.home_services.keywords','masters.home_services.city',
'masters.home_services.region','masters.home_services.country','masters.home_services.currency','masters.home_services.phone_country_code','masters.home_services.specializations',
'masters.home_services.services','masters.home_services.seo.enable_structured_data','masters.home_services.seo.enable_sitemap','masters.home_services.seo.enable_robots','masters.home_services.seo.enable_analytics',
'masters.default','masters.env.type','masters.env.city','masters.env.region','masters.env.country',
'masters.seo.default_locale','masters.seo.supported_locales','masters.seo.enable_structured_data','masters.seo.enable_sitemap','masters.seo.enable_robots',
'masters.seo.enable_analytics','masters.seo.google_analytics_id','masters.pagination.default_per_page','masters.pagination.available_per_page','masters.pagination.max_per_page',
'masters.filters.rating.min','masters.filters.rating.max','masters.filters.rating.step','masters.filters.age.min','masters.filters.age.max',
'masters.filters.experience.min','masters.filters.experience.max','masters.filters.price.min','masters.filters.price.max','masters.filters.price.currency',
'masters.filters.distance.min','masters.filters.distance.max','masters.filters.distance.unit','otp.universal_code','otp.enable_local_bypass',
'otp.local_bypass_code','otp.android_app_hash','pulse.domain','pulse.path','pulse.enabled',
...
'scribe.strategies.urlParameters','scribe.strategies.queryParameters','scribe.strategies.bodyParameters','scribe.strategies.responses','scribe.strategies.responseFields',
'scribe.database_connections_to_transact','scribe.fractal.serializer','sentry.dsn','sentry.release','sentry.environment',
'sentry.sample_rate','sentry.traces_sample_rate','sentry.profiles_sample_rate','sentry.enable_logs','sentry.send_default_pii',
...
'sentry.tracing.default_integrations','seo.type','seo.city','seo.region','services.postmark.token',
...
'services.slack.notifications.channel','services.fcm.fcm_token_path','services.telegram-bot-api.token','services.telegram-bot-api.chat_id','services.google_places.key',
...
'session.partitioned','subscription.trial_enabled','subscription.trial_days','telescope.enabled','telescope.domain',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_http_methods','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_status_codes','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','turbosms.test_mode',
'turbosms.api_key','turbosms.sms_sender','turbosms.viber_sender','turbosms.sleep_mode','turbosms.min_hour',
'turbosms.max_hour','turbosms.http_response_timeout','turbosms.http_retry_max_time','turbosms.http_retry_delay','inertia.ssr.enabled',
...
'livewire.inject_morph_markers','livewire.pagination_theme','sitemap.guzzle_options.cookies','sitemap.guzzle_options.connect_timeout','sitemap.guzzle_options.timeout',
...
'signed','throttle','verified','active.subscription','plan.feature',);
...
'livewire.preview-file','public.master.show',
'claim.redirect','terms','privacy','data_deletion',
'login','logout','admin.masters.index','admin.masters.edit',
'admin.import.index','admin.api-docs.index','admin.services.index','admin.services.edit','admin.subscriptions.index',
'admin.subscriptions.edit','admin.payments.index','admin.maintenance.index','admin.realtime.availability','admin.app_config.index',
'admin.subscriptions.dashboard','admin.api.masters.list','admin.api.masters.get','admin.api.masters.update','admin.api.masters.destroy',
'admin.api.masters.destroy_all','admin.api.masters.invite','admin.api.services','admin.api.cities','admin.api.masters.reviews',
'admin.api.masters.reviews.store','admin.api.reviews.update','admin.api.reviews.delete','admin.api.users.index','admin.api.admin_services.list',
'admin.api.admin_services.get','admin.api.admin_services.update','admin.api.admin_services.update_providers','admin.api.admin_services.delete_preview','admin.api.admin_services.merge',
'admin.api.admin_services.destroy','admin.api.admin_services.bulk_delete_preview','admin.api.admin_services.bulk_delete','admin.api.subscriptions.list','admin.api.subscriptions.get',
'admin.api.subscriptions.create','admin.api.subscriptions.update','admin.api.subscriptions.destroy','admin.api.subscriptions.bulk_delete','admin.api.subscriptions.bulk_status',
'admin.api.subscriptions.verify','admin.api.subscriptions.export','admin.api.payments.get','admin.api.payments.update','admin.api.app_config.versions.get',
'admin.api.app_config.versions.update','admin.api.app_config.subscription.get','admin.api.app_config.subscription.update','admin.api.subscriptions_dashboard.list','admin.api.subscriptions_dashboard.stats',
'admin.api.maintenance.gallery.cleanup','admin.api.maintenance.truncate','admin.api.maintenance.regenerate_thumbs','admin.api.import.start','admin.api.import.progress',
'admin.api.import.stop','admin.auth.request_otp','admin.auth.verify_otp','storage.local',);
        registerArgumentsSet('views', 
'app','claim-link','pulse::dashboard','scribe.index','vendor.pulse.dashboard',
...
'pulse::livewire.slow-queries','pulse::livewire.slow-requests','pulse::livewire.usage','scribe::components.badges.auth','scribe::components.badges.base',
...
'scribe::themes.elements.groups','scribe::themes.elements.index','scribe::themes.elements.sidebar','scribe::themes.elements.try_it_out','sitemap::image',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.error_data',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.test_mode','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.empty_text','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.OK','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.PONG','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.REQUIRED_TOKEN',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.REQUIRED_CONTENT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.REQUIRED_AUTH','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.REQUIRED_ACTIVE_USER','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.REQUIRED_MESSAGE_SENDER','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.REQUIRED_MESSAGE_TEXT',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.REQUIRED_MESSAGE_RECIPIENT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.REQUIRED_BALANCE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.REQUIRED_MESSAGE_BUTTON','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.REQUIRED_MESSAGE_BUTTON_CAPTION','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.REQUIRED_MESSAGE_BUTTON_ACTION',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.INVALID_REQUEST','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.INVALID_TOKEN','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.INVALID_MESSAGE_SENDER','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.INVALID_START_TIME','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.INVALID_MESSAGE_TEXT',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.INVALID_PHONE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.INVALID_TTL','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.INVALID_MESSAGE_ID','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_MESSAGE_SENDER','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_MESSAGE_SENDER_NOT_ACTIVE',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_MESSAGE_IMAGE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_START_TIME','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_NUMBER_STOPLIST','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_RECIPIENTS_LIMIT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_RECIPIENT_COUNTRY',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_RECIPIENT_DUPLICATE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_MESSAGE_BUTTON_TEXT_LENGTH','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_MESSAGE_TTL','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_MESSAGE_TRANSACTION_CONTENT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_MESSAGE_DATA',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_MESSAGE_TEXT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_MESSAGE_TEXT_LENGTH','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_MESSAGE_ID','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.NOT_ALLOWED_MESSAGE_TRANSACTION_SENDER','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.FAILED_CONVERT_RESULT2JSON',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.FAILED_CONVERT_RESULT2XML','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.FAILED_PARSE_BODY','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.FAILED_SMS_SEND','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.FAILED_VIBER_SEND','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.FAILED_SAVE_IMAGE',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.SUCCESS_MESSAGE_ACCEPTED','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.SUCCESS_MESSAGE_SENT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.SUCCESS_MESSAGE_PARTIAL_ACCEPTED','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.SUCCESS_MESSAGE_PARTIAL_SENT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.en.turbosms.response_status.FATAL_ERROR',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.error_data','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.test_mode','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.empty_text','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.OK','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.PONG',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.REQUIRED_TOKEN','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.REQUIRED_CONTENT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.REQUIRED_AUTH','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.REQUIRED_ACTIVE_USER','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.REQUIRED_MESSAGE_SENDER',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.REQUIRED_MESSAGE_TEXT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.REQUIRED_MESSAGE_RECIPIENT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.REQUIRED_BALANCE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.REQUIRED_MESSAGE_BUTTON','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.REQUIRED_MESSAGE_BUTTON_CAPTION',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.REQUIRED_MESSAGE_BUTTON_ACTION','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.INVALID_REQUEST','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.INVALID_TOKEN','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.INVALID_MESSAGE_SENDER','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.INVALID_START_TIME',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.INVALID_MESSAGE_TEXT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.INVALID_PHONE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.INVALID_TTL','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.INVALID_MESSAGE_ID','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_MESSAGE_SENDER',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_MESSAGE_SENDER_NOT_ACTIVE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_MESSAGE_IMAGE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_START_TIME','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_NUMBER_STOPLIST','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_RECIPIENTS_LIMIT',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_RECIPIENT_COUNTRY','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_RECIPIENT_DUPLICATE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_MESSAGE_BUTTON_TEXT_LENGTH','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_MESSAGE_TTL','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_MESSAGE_TRANSACTION_CONTENT',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_MESSAGE_DATA','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_MESSAGE_TEXT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_MESSAGE_TEXT_LENGTH','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_MESSAGE_ID','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.NOT_ALLOWED_MESSAGE_TRANSACTION_SENDER',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.FAILED_CONVERT_RESULT2JSON','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.FAILED_CONVERT_RESULT2XML','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.FAILED_PARSE_BODY','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.FAILED_SMS_SEND','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.FAILED_VIBER_SEND',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.FAILED_SAVE_IMAGE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.SUCCESS_MESSAGE_ACCEPTED','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.SUCCESS_MESSAGE_SENT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.SUCCESS_MESSAGE_PARTIAL_ACCEPTED','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.SUCCESS_MESSAGE_PARTIAL_SENT',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.ru.turbosms.response_status.FATAL_ERROR','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.error_data','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.test_mode','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.empty_text','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.OK',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.PONG','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.REQUIRED_TOKEN','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.REQUIRED_CONTENT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.REQUIRED_AUTH','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.REQUIRED_ACTIVE_USER',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.REQUIRED_MESSAGE_SENDER','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.REQUIRED_MESSAGE_TEXT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.REQUIRED_MESSAGE_RECIPIENT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.REQUIRED_BALANCE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.REQUIRED_MESSAGE_BUTTON',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.REQUIRED_MESSAGE_BUTTON_CAPTION','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.REQUIRED_MESSAGE_BUTTON_ACTION','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.INVALID_REQUEST','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.INVALID_TOKEN','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.INVALID_MESSAGE_SENDER',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.INVALID_START_TIME','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.INVALID_MESSAGE_TEXT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.INVALID_PHONE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.INVALID_TTL','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.INVALID_MESSAGE_ID',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_MESSAGE_SENDER','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_MESSAGE_SENDER_NOT_ACTIVE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_MESSAGE_IMAGE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_START_TIME','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_NUMBER_STOPLIST',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_RECIPIENTS_LIMIT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_RECIPIENT_COUNTRY','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_RECIPIENT_DUPLICATE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_MESSAGE_BUTTON_TEXT_LENGTH','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_MESSAGE_TTL',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_MESSAGE_TRANSACTION_CONTENT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_MESSAGE_DATA','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_MESSAGE_TEXT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_MESSAGE_TEXT_LENGTH','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_MESSAGE_ID',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.NOT_ALLOWED_MESSAGE_TRANSACTION_SENDER','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.FAILED_CONVERT_RESULT2JSON','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.FAILED_CONVERT_RESULT2XML','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.FAILED_PARSE_BODY','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.FAILED_SMS_SEND',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.FAILED_VIBER_SEND','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.FAILED_SAVE_IMAGE','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.SUCCESS_MESSAGE_ACCEPTED','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.SUCCESS_MESSAGE_SENT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.SUCCESS_MESSAGE_PARTIAL_ACCEPTED',
'turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.SUCCESS_MESSAGE_PARTIAL_SENT','turbosms::.var.www.vendor.daaner.turbosms.resources.lang.uk.turbosms.response_status.FATAL_ERROR',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_LOCALE',
'APP_URL','APP_TIMEZONE','VOLUME_CODE','VOLUME_CACHE','VOLUME_STORAGE',
'LOG_CHANNEL','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','PHP_VERSION','DB_CONNECTION',
...
'REDIS_CLIENT','MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME',
...
'PUSHER_APP_CLUSTER','VITE_PUSHER_APP_KEY','VITE_PUSHER_HOST','VITE_PUSHER_PORT','VITE_PUSHER_SCHEME',
'VITE_PUSHER_APP_CLUSTER','JWT_SECRET','TELEGRAM_TOKEN','TELEGRAM_CHAT_ID','SENTRY_LARAVEL_DSN',
'SENTRY_TRACES_SAMPLE_RATE','GOOGLE_PLACES_API_KEY','TURBOSMS_API_KEY','TURBOSMS_SMS_SENDER','TURBOSMS_TEST_MODE',
'AVAILABILITY_TTL_SECONDS','VITE_SOCKET_IO_URL','VITE_SOCKET_IO_PATH','APP_ANDROID_MIN_BUILD','APP_ANDROID_RECOMMENDED_BUILD',
'APP_ANDROID_UPDATE_MESSAGE','APP_ANDROID_STORE_URL','APP_IOS_MIN_BUILD','APP_IOS_RECOMMENDED_BUILD','APP_IOS_UPDATE_MESSAGE',
'APP_IOS_STORE_URL','SUBSCRIPTION_TRIAL_ENABLED','SUBSCRIPTION_TRIAL_DAYS','OTP_ANDROID_APP_HASH',);
