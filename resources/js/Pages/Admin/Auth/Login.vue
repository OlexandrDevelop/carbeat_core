<template>
    ...
    >
        ...
        >
            <div
                class="grid w-full grid-cols-1 items-center gap-10 lg:grid-cols-2"
            >
                <div class="hidden lg:block">
                    <div
                        class="relative rounded-3xl bg-black p-1 shadow-2xl shadow-gray-300/40"
                    >
                        <div
                            class="rounded-3xl bg-gradient-to-br from-gray-900 to-gray-800 p-8"
                        >
                            <h2
                            ...
                            <p class="max-w-md text-gray-400">
                                Manage masters with a clean, fast, and secure
                                interface.
                            </p>
                            <div
                                class="mt-8 grid grid-cols-3 gap-3 text-center text-gray-400"
                            >
                ...
                <div>
                    <div
                        class="mx-auto w-full max-w-md rounded-3xl border border-gray-200 bg-white/80 p-8 shadow-xl backdrop-blur"
                    >
                        <div class="mb-6 text-center">
                            <div
                                class="mx-auto mb-3 grid h-12 w-12 place-items-center rounded-2xl bg-black text-white"
                            >
                        ...
                        <div v-else class="space-y-4">
                            ...
                            <input
                                ...
                                maxlength="6"
                                placeholder="000000"
                                class="w-full rounded-2xl bg-gray-100 px-4 py-3 text-center text-lg tracking-widest focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                            <button
                                @click="verifyOtp"
...
async function verifyOtp() {
    ...
    loading.value = true;
    try {
        await axios.post('/admin-auth/verify-otp', {
            phone: phone.value,
            sms_code: otp.value,
        });
